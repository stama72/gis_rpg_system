...
execute if score @s gis_skill_sub_2 matches 9 if score @s gis_skill_using matches 9 if score @s gis_skill_using_count matches 20.. if predicate gis:entity_check/is_sneak run function gis:system/player/skill/attacker/9_fist_b_strike
