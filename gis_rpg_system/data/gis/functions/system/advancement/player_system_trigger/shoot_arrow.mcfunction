...
execute if score @s gis_skill_main_2 matches 1 as @s[x_rotation=-90..-30] run function gis:system/player/skill/hunter/1_bow_b
execute if score @s gis_skill_main_1 matches 3 run function gis:system/player/skill/hunter/3_bow_a
execute if score @s gis_skill_main_2 matches 5 as @s[x_rotation=-90..-30] run function gis:system/player/skill/hunter/5_bow_b
