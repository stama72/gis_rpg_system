...
execute store result entity @s Owner[0] int 1 run data get storage minecraft:gis_temp skill.hunter_5.owner.0
execute store result entity @s Owner[1] int 1 run data get storage minecraft:gis_temp skill.hunter_5.owner.1
execute store result entity @s Owner[2] int 1 run data get storage minecraft:gis_temp skill.hunter_5.owner.2
execute store result entity @s Owner[3] int 1 run data get storage minecraft:gis_temp skill.hunter_5.owner.3
