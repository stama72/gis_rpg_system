...
#continue
execute if score @s gis_skill_using matches 2 if score @s gis_skill_sub_1 matches 2 run function gis:system/player/skill/tank/2_shield_a_continue
...
execute if score @s gis_skill_sub_2 matches 4 if predicate gis:entity_check/is_sneak run return run function gis:system/player/skill/tank/4_shield_b
