...
execute if score @s gis_skill_main_2 matches 6 run function gis:system/player/skill/attacker/6_sword_b
execute if score @s gis_skill_main_2 matches 8 run function gis:system/player/skill/attacker/8_sword_b
