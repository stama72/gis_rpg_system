...
execute on owner run tag @s add normal_attack
...
execute if entity @s[tag=arrow_skill_1_rain_shot] on owner run return run tag @s add arrow_skill_1_player
execute if entity @s[tag=arrow_skill_5_rain_shot] on owner run return run tag @s add arrow_skill_5_player
execute on origin run tag @s add arrow_normal_attack_player
execute on owner run tag @s add arrow_normal_attack_player