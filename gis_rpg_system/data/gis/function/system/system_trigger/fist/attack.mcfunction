...
#continue
execute if score @s gis_skill_using matches 3 if score @s gis_skill_sub_1 matches 3 run function gis:system/player/skill/attacker/3_fist_a_continue
execute if score @s gis_skill_using matches 7 if score @s gis_skill_sub_1 matches 7 run function gis:system/player/skill/attacker/7_fist_a_continue
