...
$execute if score #0 gis_const matches $(mode) at $(attacker) facing entity @s feet positioned ^ ^ ^3.0 rotated as $(attacker) rotated ~ ~ positioned ^ ^4.0 ^ as $(attacker) as @s[distance=..5.0] run return 1
