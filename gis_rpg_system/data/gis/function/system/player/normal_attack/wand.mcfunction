...
#damage calc
execute if score @p[tag=normal_attack] gis_job matches 1..3 run scoreboard players operation @s gis_damage *= #3 gis_const
execute if score @p[tag=normal_attack] gis_job matches 4 run scoreboard players operation @s gis_damage *= #5 gis_const
