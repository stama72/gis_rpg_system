...
tag @s add sword_skill_8_player
execute at @s run summon marker ~ ~ ~ {UUID:[I;90,0,2,2]}
execute at @s rotated as @p[tag=sword_skill_8_player] positioned ^ ^ ^-0.01 run tp 0000005a-0000-0000-0000-000200000002 ~ ~ ~ ~ ~
execute at @s as @e[type=#enemy,distance=..10] run function gis:system/player/skill/attacker/8_sword_b_enemy

tag @s remove sword_skill_8_player
