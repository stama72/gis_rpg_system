...
#summon arrow
execute at @s run summon arrow ~ ~ ~ {pickup:0b,Owner:[I;0,0,0,0],damage:10d,PierceLevel:3b,Motion:[0.0,-1.0,0.0],Rotation:[0F,-90F],Tags:["arrow_skill_5_rain_shot"],CustomName:'{"color":"#2B80FF","italic":false,"text":"アライズ"}',Potion:"minecraft:water",item:{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:water"}}}}
