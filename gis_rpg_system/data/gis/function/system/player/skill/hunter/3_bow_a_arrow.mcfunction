...
execute positioned ~ ~0.5 ~ unless entity @e[type=#projectile,distance=..3] run return 0
...
execute at @s positioned ~ ~0.5 ~ as @e[type=#projectile,distance=..3] run function gis:system/player/skill/hunter/3_bow_a_arrow_move
