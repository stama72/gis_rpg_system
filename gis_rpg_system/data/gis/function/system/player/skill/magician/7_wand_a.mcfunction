...
#ボルケーノキャノン召喚
execute at @s positioned ~ ~1 ~ rotated as 0000005a-0000-0000-0000-000100000002 run summon fireball ^ ^ ^0.5 {Invulnerable:1b,PortalCooldown:300,Tags:["no_mob_convert","gis_kill","gis_kill_pause","fire_magician_skill_7"],CustomName:'"ボルケーノキャノン"'}
#オーナー指定
data modify entity @n[tag=fire_magician_skill_7] Owner set from entity @s UUID
...
#ファイアショットを前方へ飛ばす
execute at @s positioned ~ ~1 ~ rotated as 0000005a-0000-0000-0000-000100000002 positioned ^ ^ ^0.5 as @n[tag=fire_magician_skill_7] run function gis:system/player/skill/magician/magical_shot_move

kill 0000005a-0000-0000-0000-000100000002
tag @s remove wand_skill_7_player