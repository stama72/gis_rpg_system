...
#ファイアショット召喚
execute at @s positioned ~ ~1 ~ rotated as 0000005a-0000-0000-0000-000100000002 run summon fireball ^ ^ ^1 {Silent:1b,Invulnerable:1b,PortalCooldown:300,Tags:["no_mob_convert","gis_kill","gis_kill_pause","fire_magician_skill_1"],CustomName:'"ファイアショット"'}
#オーナー指定
...
#ファイアショットを前方へ飛ばす
execute at @s positioned ~ ~1 ~ rotated as 0000005a-0000-0000-0000-000100000002 positioned ^ ^ ^1 as @n[tag=fire_magician_skill_1] run function gis:system/player/skill/magician/magical_shot_move
