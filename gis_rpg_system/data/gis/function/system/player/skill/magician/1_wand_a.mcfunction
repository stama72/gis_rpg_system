...
#ファイアショット召喚
execute at @s positioned ~ ~1 ~ rotated as 0000005a-0000-0000-0000-000100000002 run summon small_fireball ^ ^ ^0.5 {Invulnerable:1b,PortalCooldown:300,Tags:["no_mob_convert","gis_kill","gis_kill_pause","fire_magician_skill_1"],CustomName:'"ファイアショット"'}
#オーナー指定
