...
#上下幅3m
scoreboard players set #gis_temp gis_temp_1 0
execute store result score #gis_temp gis_temp_1 run function gis:system/util/collision_detection/is_lower {attacker:"0000005a-0000-0000-0000-000200000002",mode:"1",shift:2,rotation:0}
execute if score #gis_temp gis_temp_1 matches 0 run return 0
say lower

execute store result score #gis_temp gis_temp_1 run function gis:system/util/collision_detection/is_upper {attacker:"0000005a-0000-0000-0000-000200000002",mode:"2",shift:1,rotation:0}
execute if score #gis_temp gis_temp_1 matches 0 run return 0
